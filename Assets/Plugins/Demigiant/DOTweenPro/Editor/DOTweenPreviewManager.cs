...
namespace DG.DOTweenEditor
{
    public static class DOTweenPreviewManager
    {
        ...
        private static readonly Dictionary<DOTweenAnimation, TweenInfo> _AnimationToTween =
        ...
        public static bool PreviewGUI(DOTweenAnimation src)
        {
            ...
            EditorGUI.EndDisabledGroup();
            EditorGUI.BeginDisabledGroup(!isPreviewing);
            if (GUILayout.Button("■ Stop All <i>on GameObject</i>", Styles.btPreview)) StopPreview(src.gameObject);
            if (GUILayout.Button("■ Stop All <i>in Scene</i>", Styles.btPreview)) StopAllPreviews();
            EditorGUI.EndDisabledGroup();
            GUILayout.EndHorizontal();
            if (isPreviewing)
            {
...
//                GUILayout.Label("Paused Tweens: " + playingTweens);
        ...
        {
            _TmpKeys.Clear();
            foreach (var kvp in _AnimationToTween) _TmpKeys.Add(kvp.Key);
