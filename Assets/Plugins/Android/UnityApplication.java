...
public class UnityApplication extends Application {
    ...
    public void onCreate() {
        ...
        AdInitializer.init(
                //appId是我们提供给您的一串数值
                new AdInitializer.Builder(this, "3969065")
                        //设置banner广告的单元ID
                        .setBannerUnitId("ca-app-pub-2270136017335510/5359322361")
                        //设置插屏广告的单元ID
                        .setInterstitialUnitId("ca-app-pub-2270136017335510/2733159028")
                        //设置激励视频广告的单元ID
                        .setRewardUnitId("ca-app-pub-2270136017335510/1917936653")
                        //开启debuggable 展示测试广告
                        //请在正式上线环境下，设为false
                        .setDebuggable(false)
