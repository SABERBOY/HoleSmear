...
{
    [Space(10)] public int layer;
    [Space(10)] public Collider xAxis;
    public Collider yAxis;
    public Collider zAxis;
    [Space(10)] public Collider xyPlane;
    public Collider xzPlane;
    public Collider yzPlane;
    [Space(10)] public Collider xyRotate;
    public Collider xzRotate;
    public Collider yzRotate;
    [Space(10)] public Collider sphereRotate;
    [Space(10)] public float rotationSpeed = 4.0f;
    ...
    private void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (Physics.Raycast(ray, out hit, 1000f, layer))
            {
                ...
                else if (hit.collider == xyRotate)
                {
                    ...
                    lookHitPoint = hit.point - transform.position -
                                   Vector3.Project(hit.point - transform.position, transform.forward);
                ...
                else if (hit.collider == xzRotate)
                {
                    ...
                    lookHitPoint = hit.point - transform.position -
                                   Vector3.Project(hit.point - transform.position, transform.up);
                    //Debug.DrawLine(transform.position, transform.position + lookHitPoint, Color.cyan, 10.0f);
                    dragplane.SetNormalAndPosition(lookHitPoint, hit.point);
                    //DrawPlane(lookHitPoint, transform.position + lookHitPoint, 10.0f);
                    rotating = true;
                ...
                else if (hit.collider == yzRotate)
                {
                    ...
                    lookHitPoint = hit.point - transform.position -
                                   Vector3.Project(hit.point - transform.position, transform.right);
                    //Debug.DrawLine(transform.position, transform.position + lookHitPoint, Color.cyan, 10.0f);
                    dragplane.SetNormalAndPosition(lookHitPoint, hit.point);
                    //DrawPlane(lookHitPoint, transform.position + lookHitPoint, 10.0f);
                    rotating = true;
                ...
                if (rotating)
                {
                    if (dragplane.Raycast(ray, out rayDistance)) startDragRot = ray.GetPoint(rayDistance);
        ...
        if (dragging || rotating)
        {
            ...
            if (dragplane.Raycast(ray, out rayDistance)) mousePos = ray.GetPoint(rayDistance);
            ...
            if (rotating)
            {
                ...
                var rotationAxis2 = Vector3.zero;
