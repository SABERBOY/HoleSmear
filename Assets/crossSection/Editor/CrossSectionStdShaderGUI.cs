    ...
    internal class CrossSectionStdShaderGUI : ShaderGUI
    {
        ...
        private static class Styles
        {
            ...
            public static GUIContent[] uvSetOptions = new GUIContent[]
                { new GUIContent("UV channel 0"), new GUIContent("UV channel 1") };
            ...
            public static GUIContent detailAlbedoText =
                new GUIContent("Detail Albedo x2", "Albedo (RGB) multiplied by 2");
            ...
            public static GUIContent emissiveColorWarning =
                new GUIContent("Ensure emissive color is non-black for emission to have effect.");
        ...
        private MaterialProperty sectionColor = null;
        private MaterialProperty inverse = null;
        private MaterialProperty stencilMask = null;
        private MaterialProperty retractBackfaces = null;
