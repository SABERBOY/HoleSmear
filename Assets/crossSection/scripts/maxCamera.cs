...
public class maxCamera : MonoBehaviour
{
    ...
    public void Init()
    {
        ...
        var cross = Vector3.Cross(Vector3.right, transform.right);
    ...
    private void LateUpdate()
    {
        ...
        var scrollinp = Input.GetAxis("Mouse ScrollWheel");
#if UNITY_WEBGL
    ...
    {
        dragging = true;
        var startTargetPos = target.position;
        ...
        {
            var mouseMove = 0.005f * transform.position.y * (Input.mousePosition - startingHit);
