...
half4 fragForwardClipBaseInternal(VertexOutputForwardClipBase i)
{
    ...
    #if UNITY_PACK_WORLDPOS_WITH_TANGENT
    PLANE_CLIP(float3(i.tangentToWorldAndPackedData[0].w, i.tangentToWorldAndPackedData[1].w,
...
)
{
    ...
    emissiveColor += UNITY_BRDF_GI(s.diffColor, s.specColor, s.oneMinusReflectivity, s.smoothness, s.normalWorld,
