...
half4 fragForwardBaseInternal_TCP2(VertexOutputForwardBase i)
{
    ...
    #else
    half4 c = TCP2_BRDF_PBS(s.diffColor, s.specColor, s.oneMinusReflectivity, s.oneMinusRoughness, s.normalWorld,
    ...
    c.rgb += UNITY_BRDF_GI(s.diffColor, s.specColor, s.oneMinusReflectivity, s.oneMinusRoughness, s.normalWorld,
                           -s.eyeVec, occlusion, gi);
    #endif
