...
public static class TCP2_ExpressionParser
{
    ...
    public static string ProcessCondition(string line, List<string> features, ref int depth, ref List<bool> stack,
        ref List<bool> done)
    {
    ...
    public class Token
    {
        private static Dictionary<char, KeyValuePair<TokenType, string>> typesDict =
