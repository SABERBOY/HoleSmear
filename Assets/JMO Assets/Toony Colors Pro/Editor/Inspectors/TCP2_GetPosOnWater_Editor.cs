...
public class TCP2_GetPosOnWater_Editor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.HelpBox(
            "Use this script with a Water Template-generated shader to get the water height at a specific world point.\n\nMake sure that the shader has the following features enabled:\n- Custom Time\n- Vertex Waves\n- World-based Position\n\nMake sure to also use the TCP2_ShaderUpdateUnityTime script!",
            MessageType.Info);
        base.OnInspectorGUI();
    }
}