...
//	MaterialProperty reflections = null;
    ...
    //TCP2
    private List<MaterialProperty> SGProperties;
            ...
            if (property != null)
                switch (property.name)
                {
                    ...
                    case "_BumpMap":
                        ...
                        break;
                    case "_Parallax":
                        heigtMapScale = property;
                        break;
                    case "_ParallaxMap":
                        heightMap = property;
                        break;
                    case "_OcclusionStrength":
                        occlusionStrength = property;
                        break;
                    case "_OcclusionMap":
                        occlusionMap = property;
                        break;
                    case "_EmissionColor":
                        emissionColorForRendering = property;
                        break;
                    case "_EmissionMap":
                        emissionMap = property;
                        break;
                    case "_DetailMask":
                        detailMask = property;
                        break;
                    case "_DetailAlbedoMap":
                        detailAlbedoMap = property;
                        break;
                    case "_DetailNormalMapScale":
                        detailNormalMapScale = property;
                        break;
                    case "_DetailNormalMap":
                        detailNormalMap = property;
                        break;
                    //case "_UVSec": uvSetSecondary = property; break;

                    // TCP2
                    case "_HColor":
                        tcp2_highlightColor = property;
                        break;
                    case "_SColor":
                        tcp2_shadowColor = property;
                        break;
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] props)
    {
        ...
        var label = Screen.width > 450f ? "TOONY COLORS PRO 2 - INSPECTOR (Generated Shader)" :
    ...
    private void UpdateOutlineNormalsKeyword(int index)
    {
    ...
    private static void SetMaterialKeywords(Material material, WorkflowMode workflowMode)
    {
        ...
        */
        ...
        var shouldEmissionBeEnabled = material.HasProperty("_EmissionColor") &&
 ...
 material.HasProperty("_EmissionColor") && ShouldEmissionBeEnabled(material, material.GetColor("_EmissionColor"));
