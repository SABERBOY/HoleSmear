...
public partial class TCP2_ShaderGenerator : EditorWindow
{
    ...
    public class UIFeature
    {
        ...
        public void DrawGUI(TCP2_Config config)
        {
            ...
            else if (visible)
            {
                ...
                var labelPosition = HeaderRect(ref position,
    ...
    public class UIFeature_Mask : UIFeature
    {
        ...
        private string[] labels = { "Off", "Main Texture", "Mask 1", "Mask 2", "Mask 3", "Vertex Colors" };
        private string[] masks = { "", "mainTex", "mask1", "mask2", "mask3", "vcolors" };
        private string[] uvs = { "Main Tex UV", "Independent UV0", "Independent UV1" };
    ...
    {
        private static List<UIFeature_DropDownStart> AllDropDowns = new List<UIFeature_DropDownStart>();
