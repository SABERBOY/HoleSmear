...
namespace NotificationSamples.Demo
{
    ...
    {
        [Tooltip("Item's title.")] public string Title;

        [Tooltip("Item's description.")] public string Description;

        [Tooltip("The item's icon to use in the UI.")]
        public Sprite Icon;

        [Tooltip("Item's initial cost.")] public int InitialCost;
        ...
        [Tooltip("Notification icon ID.")] public string IconId;
    }
}