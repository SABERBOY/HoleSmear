...
namespace AnyThinkAds.Api
{
    public class ATNativeBannerAdShowingExtra
    {
        ...
        public static readonly string kATNativeBannerAdShowingExtraCTAButtonBackgroundColor =
            "cta_button_background_color";

        public static readonly string
            kATNativeBannerAdShowingExtraCTATextColor = "cta_button_title_color"; //of type string, example:#3e2f10
    ...
    public class ATNativeBannerAd
    {
        ...
        public static ATNativeBannerAd Instance => instance;
        ...
        {
            return ATAdsClientFactory.BuildNativeBannerAdClient();
        }
    }
}