...
public class AdHelper
{
    ...
    {
        if (_instance == null) _instance = new AdHelper();
    ...
    private void InitAndroidBridge(string deviceId)
    {
        if (_androidObject == null)
        {
            ...
            var BuildModeController = new GameObject("PayAdObject");
     ...
     */
    public static void showBanner(BannerListener bannerListener, int startMargin, int endMargin, int bottomMargin,
        Horizon horizMode = Horizon.HORIZ_MODEL_CENTER)
    {
